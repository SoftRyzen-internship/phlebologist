...
const Treatments: React.FC<TreatmentsProps> = ({ staticData, lang }) => {
  ...
  return (
    <section className="mt-[-30px] md:mt-[-56px] xl:mt-[-68px]" id="methods">
      <div className="container">
        <div
          data-aos="fade-up"
          data-aos-duration="1500"
          className="wrapper rounded-medium bg-white pb-[62px] pt-6 md:rounded-extraLarge md:pb-[96px] md:pt-[40px] xl:relative xl:flex xl:h-[831px] xl:flex-col xl:flex-wrap xl:rounded-max xl:pb-[142px] xl:pt-16"
        >
