  ...
  return (
    ...
    >
      <div className="container">
        <div className="wrapper relative rounded-medium bg-gray-light pb-[62px] pt-[24px] md:rounded-extraLarge md:pb-[96px] md:pt-[40px] xl:rounded-max xl:pb-[142px] xl:pt-[64px]">
          <Heading
            variant="primary"
