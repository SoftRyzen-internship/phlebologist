    ...
    return (
      <section id="banner" className={className}>
        <div className="container">
          <div className="wrapper banner-bg relative flex h-[647px] flex-col justify-between rounded-t-medium pb-[52px] pt-6 md:h-auto md:items-start md:gap-12 md:rounded-t-extraLarge md:pb-20 md:pt-[94px] xl:gap-16 xl:rounded-t-max xl:pb-[239px] xl:pt-[186px]">
            <Heading
              tag="h2"
