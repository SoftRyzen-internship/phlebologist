    ...
    >
      ...
      <p
        className={classNames({
          ...
          'mt-5 text-[14px] md:mt-[28px] md:text-[16px] xl:mt-[30px] smOnly:mb-5':
            true,
        })}
      >
