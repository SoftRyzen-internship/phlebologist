...
const RoutingLinkButton: React.FC<RoutingLinkButtonProps> = ({
  ...
  const btnClass = classnames(
    ...
    'outline-without flex items-center justify-center w-[256px] h-[51px] md:w-auto mdOnly:px-12 bg-gray-light text-black-dark text-base rounded-normal leading-normal -tracking-[0.64px]',
